<template>
  <a-modal
    ...
    :footer="null"
    :keyboard="false"
    style="top: 0px; margin-right: 0px; padding: 0px"
    width="800px"
  >
    <div class="px-[24px]">
      <div class="flex justify-between">
        ...
        <span
          class="text-[#28C57C] cursor-pointer pt-[6px]"
          @click="toggle"
        >
          <img
      ...
      <div ref="root">
        <div
          ...
          class="fullscreen-wrapper rounded-[22px] p-[24px]"
          :class="fullscreen ? 'fullStyle' : ''"
        >
          <div
            v-if="fullscreen"
            class="text-right cursor-pointer pb-[12px]"
            :class="fullscreen ? 'resetoreFixed' : ''"
            @click="toggle"
          >
            <img
              src="@/assets/icons/flod.svg"
              class="w-[18px] mr-[10px]"
            />
          ...
          <div
            class="main text-white bg-black bg-[#000000] break-all pt-[30px]"
            :style="{
              height: bodyHeight,
            }"
          >
            <div
              ref="scrollDom"
              class="scrollDom pb-[24px]"
            >
              <div
                v-for="(it, idx) in stagesData.content"
                :key="idx"
                class=""
              >
                {{ it }}
